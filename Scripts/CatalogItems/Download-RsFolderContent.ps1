...
function Download-RsFolderContent
{
    param(
        [string]
    ...
    foreach($item in $items)
    {
        ...
        {
            # We're relying on the fact that the implementation of List-RsCatalogItems will show us the folder before their content, 
            ...
            Download-RsCatalogItem -proxy $proxy -Path $item.Path -Destination $folder
        }
    }
}