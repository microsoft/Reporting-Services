...
.EXAMPLE
    ...
    Link-RsDataSet -ReportServerUri 'http://localhost/reportserver_sql2012' -ItemPath /DataSet -DataSourceName DataSource1 -DataSetPath /Datasources/SampleSource
...
function Link-RsDataSource
{
    ...
    Write-Ouput "Set dataSource reference '$DataSourceName' of item $ItemPath to $DataSourcePath"
